...
object Stdlib_Operator_LessThanOrEquals3 extends RTFunction {

  def call(callObject: CallObject):RTObject = {
    Stdlib_Operator_LessThan.call(callObject) match {
      case t @ Stdlib_Boolean(true) => t
      case _ => Stdlib_Operator_Equals3.call(callObject)
    }
  }
